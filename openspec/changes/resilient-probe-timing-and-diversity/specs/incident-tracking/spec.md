...
- **WHEN** status is `INFO` (e.g. the LAN gateway has never responded this session, or an isolated redundant probe dropped with VPN inactive) and no incident is currently open
