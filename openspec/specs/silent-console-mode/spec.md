...
Suppresses HEALTHY console output during background monitoring to reduce terminal noise, while preserving all logfile entries and alerting on non-HEALTHY events and periodic heartbeats.
